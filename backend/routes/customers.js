...
// Get all customers
router.get('/', verifyToken, checkPermission('customers_view'), (req, res) => {
...
// Get single customer
router.get('/:id', verifyToken, checkPermission('customers_view'), (req, res) => {
    const { id } = req.params;
...
// Add customer
router.post('/', verifyToken, checkPermission('customers_crud'), (req, res) => {
...
// Update customer
router.put('/:id', verifyToken, checkPermission('customers_crud'), (req, res) => {
    const { id } = req.params;
...
// Delete customer
router.delete('/:id', verifyToken, checkPermission('customers_crud'), (req, res) => {
    const { id } = req.params;
...
// Get customer stats
router.get('/stats', verifyToken, checkPermission('customers_view'), (req, res) => {
    db.get(`
        SELECT 
